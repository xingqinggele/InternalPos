package com.example.internalpos.homefragment.homeequipment.adapter;
...
import com.example.internalpos.homefragment.homeequipment.hodler.ChooserRecyclerViewHodler;
...
public class ChooserRecyclerAdapter extends RecyclerView.Adapter<ChooserRecyclerViewHodler>{
    ...
    public void onBindViewHolder(ChooserRecyclerViewHodler holder, int position) {
        ...
        holder.postype.setText(list.get(position).getPosName());
